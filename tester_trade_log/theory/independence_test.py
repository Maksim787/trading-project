...
df = df.dropna()
good_columns = ['close', 'volume', 'rsi', 'tsi', 'kama', 'roc', 'srsi',
                'ppo', 'pvo', 'aroon', 'macd', 'ema', 'sma', 'wma', 'trix', 'ksti',
                'dpoi', 'stc', 'blb', 'ulc', 'obv', 'frc', 'vpt', 'npt', 'new_price', 'trand_of_price',
                'change_of_price', 'old_change_of_price']
print(sm.stats.acorr_ljungbox("test:", df['change_of_price'], lags=[30   ], return_df=True))
