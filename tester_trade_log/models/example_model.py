...
class Model:
    ...
    def get_score(self):
        """tree.plot_tree(self._model, feature_names=self._df.columns)
        plt.show()"""
...
ans = []
for i in range(2, 7):
    p = Model("analysis/data/tickers_trade_log", "SBER", datetime.timedelta(minutes=1), "classificator", DecisionTreeClassifier(max_depth=i))
